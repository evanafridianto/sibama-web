...
<!-- Modal-Effect -->
<script src="<?= base_url() ?>assets/admin/plugins/custombox/js/custombox.min.js"></script>
<script src="<?= base_url() ?>assets/admin/plugins/custombox/js/legacy.min.js"></script>
<!-- DataTable  -->
