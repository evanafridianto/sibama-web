    ...
    <div class="container">
        ...
        <ul class="nav navbar-nav navbar-left nav-menu-left">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-3 list-unstyled megamenu-list">
                                    ...
                                    <p class="text-muted font-13">
                                        Adminox is a fully featured premium admin template built on top of
                                        awesome Bootstrap 3.3.7, modern web technology HTML5, CSS3 and
                                        jQuery. It has many ready to use hand crafted components. The theme
                                        is fully responsive and easy to customize. The code is super easy to
                                        understand and gives power to any developer to turn this theme into
                                ...
                                <ul class="col-sm-6 col-md-3 list-unstyled megamenu-list">
                                    ...
                                    <li>
                                        <a href="javascript:;"><i class="fi-air-play text-muted"></i>
                                            Dashboard</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;"><i class="fi-target text-muted"></i> Admin UI
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;"><i class="fi-help text-muted"></i> Tickets
                                            <span class="badge badge-danger">New</span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:;"><i class="fi-paper text-muted"></i>Task
                                            Board</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;"><i class="fi-bar-graph-2 text-muted"></i>
                                            Charts</a>
                                    </li>
                                </ul>
                                ...
                                <ul class="col-sm-6 col-md-3 list-unstyled megamenu-list">
                                    ...
                                    <li>
                                        <a href="javascript:;"><i class="fi-briefcase text-muted"></i> UI
                                            Kit </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="javascript:;"><i class="fi-mail text-muted"></i> Email
                                            <span class="badge badge-success">32</span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:;"><i class="fi-disc text-muted"></i>Forms</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;"><i class="fi-layout text-muted"></i>
                                            Tables</a>
                                    </li>
                                </ul>
                                ...
                                <ul class="col-sm-6 col-md-3 list-unstyled megamenu-list">
                                    ...
                                    <li>
                                        <a href="javascript:;"><i class="fi-clock text-muted"></i> Calendar
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;"><i class="fi-marquee-plus text-muted"></i>
                                            Extra Pages <span class="label label-info">22</span></a>
                                    </li>
                                    <li>
            ...
            <li class="dropdown hidden-xs">
                <a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle waves-effect waves-light"> Projects
        ...
        <ul class="nav navbar-nav navbar-right">
                            ...
                            <a href="javascript:void(0);" class="list-group-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading text-primary">A new order has been placed A
                                            new order has been placed</h5>
                                        <p class="m-0">
                            ...
                            <a href="javascript:void(0);" class="list-group-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="m-0">
                                            There are <span class="text-primary font-600">2</span> new
                                            updates available
                                        </p>
                                    </div>
                                </div>
            ...
            <li class="dropdown user-box">
                <a href="" class="dropdown-toggle waves-effect user-link" data-toggle="dropdown" aria-expanded="true">
                    <img src="<?=base_url()?>assets/images/users/avatar-1.jpg" alt="user-img"
